...
def main():
    ...
    wandb.init(project=args.project_name, entity="strnn-init",
               config=experiment_config, reinit=True, name=args.wandb_name)

    ian_init = 1 if args.init_method == 'ian' else 2
